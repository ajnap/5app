  ...
  theme: {
    extend: {
      colors: {
        ...
        // Soft lavender purple (primary accent)
        lavender: {
          50: '#F5F3FF',
          100: '#EDE9FE',
          200: '#DDD6FE',
        ...
        // Warm peachy coral (secondary accent)
        peach: {
          50: '#FFF7ED',
          100: '#FFEDD5',
          200: '#FED7AA',
        ...
        // Soft sage green (success states)
        sage: {
          50: '#F0FDF4',
          100: '#DCFCE7',
          200: '#BBF7D0',
      ...
      boxShadow: {
        ...
        'soft-xl': '0 16px 48px -8px rgba(0, 0, 0, 0.12), 0 32px 64px -16px rgba(0, 0, 0, 0.1)',
        'glow': '0 0 20px rgba(139, 124, 246, 0.3)',
        'glow-lg': '0 0 40px rgba(139, 124, 246, 0.4)',
      },
      animation: {
